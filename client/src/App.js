...
import TraderHome from './containers/Trader/Home';
  ...
  return (
    <AuthContext.Provider value={{ authToken, setAuthTokens: setTokens }}>
      <Layout>
        <Switch>
          <Trader>
            <PrivateRoute exact path="/trader" component={TraderHome} />
            <PrivateRoute exact path="/trader/stock-info" component={TraderStockInfo} />
          </Trader>
